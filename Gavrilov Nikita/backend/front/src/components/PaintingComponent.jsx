    ...
    return (
        <div className="m-4">
            <div className=" row my-2">
                <div className="col-auto me-auto"><h3>Картина</h3></div>
            ...
            <Form onSubmit={onSubmit}>
                <Form.Group>
                    ...
                    <Form.Label>Номер музея</Form.Label>
                    <Form.Control
                        type="text"
                        pattern="[0-9]*"
                        placeholder="Введите референсный музей"
                        onChange={(e) => {setMuseumid(parseInt(e.target.value, 10))}}
                        value={museumid}
                        name="museumid"
                        autoComplete="off"
                    />
					
					<Form.Label>Номер художника</Form.Label>
                    <Form.Control
                        type="text"
                        pattern="[0-9]*"
                        placeholder="Введите референсного художника"
