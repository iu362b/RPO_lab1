...
Java_ru_iu3_myapplication_MainActivity_randomBytes(JNIEnv *env, jclass clazz, jint no) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_myapplication_MainActivity_encrypt(JNIEnv *env, jclass clazz, jbyteArray key,
                                               jbyteArray data) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_myapplication_MainActivity_decrypt(JNIEnv *env, jclass clazz, jbyteArray key,
                                               jbyteArray data) {
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
