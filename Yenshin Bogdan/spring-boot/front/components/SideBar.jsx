...
import {faGlobe, faPalette, faUniversity, faUsers, faImage, faUser} from "@fortawesome/free-solid-svg-icons";
        ...
        <>
            { props.expanded &&
                <Nav className={"flex-column my-sidebar my-sidebar-expanded"}>
                    ...
                    <Nav.Item>
                        <Nav.Link as={Link} to="/artists"><FontAwesomeIcon icon={faPalette}/>{' '}Художники</Nav.Link>
                    </Nav.Item>
                    ...
                    <Nav.Item>
                        <Nav.Link as={Link} to="/users"><FontAwesomeIcon icon={faUsers}/>{' '}Пользователи</Nav.Link>
                    </Nav.Item>
            ...
            { !props.expanded &&
                <Nav className={"flex-column my-sidebar my-sidebar-collapsed"}>
                    ...
                    <Nav.Item>
                        <Nav.Link as={Link} to="/artists"><FontAwesomeIcon icon={faPalette} size="2x"/></Nav.Link>
                    </Nav.Item>
                    ...
                    <Nav.Item>
                        <Nav.Link as={Link} to="/users"><FontAwesomeIcon icon={faUsers} size="2x"/></Nav.Link>
                    </Nav.Item>
